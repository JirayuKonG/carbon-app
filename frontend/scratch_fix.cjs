...
// Try replacing Graph 1 title
const graph1OldRegex = /<div className="card-title">การปล่อยคาร์บอนรายกระบวนการ[^<]+<\/div>/;
...
content = content.replace(graph1OldRegex, graph1New);

// Graph 1 toggle buttons
...
// Try replacing Graph 2 PeriodSwitch
...
// Graph 2 Title
const graph2TitleOld = /<div className="card-title">รายการกิจกรรมย่อยในแต่ละขั้นตอน[^<]+<\/div>/;
const graph2TitleNew = `<div className="card-title">รายการกิจกรรมย่อยในแต่ละขั้นตอน</div>`;
content = content.replace(graph2TitleOld, graph2TitleNew);
...
console.log("Fixed Graph 1 and Graph 2 replacements!");
