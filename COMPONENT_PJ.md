...
| Activities | `backend/src/modules/activities/*` | `/api/activities` including headers/details, CSV import, import-history endpoints, and carbon queue endpoints such as `/api/activities/carbon-process-queue`. |
